...
export default function Edituser() {
    ...
    useEffect(() => {
        const userRowdata = async () => {
            const getUserdata = await fetch("http://localhost/api/user.php/" + id);
                    ...
                    <div className="col-md-6 mt-4">
                        ...
                        <form onSubmit={handleSubmit}>
                            ...
                            <div className="mb-3 row">
                                ...
                                <div className="col-sm-10">
                                    <input type="text" name="email" value={formvalue.password} className="form-control" onChange={handleInput} />
                                </div>
                            </div>
